...
from counterfactuals.ReplaceWordsPerturbation import ReplaceWordsPerturbation
...
from counterfactuals.compileSourceCode import is_syntactically_correct
...
class Entry:
    ...
    def __init__(self, classification: string, fitness: float, document_indices: [int]):
